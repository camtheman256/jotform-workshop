...
JF.initialize({ apiKey: "f3929264b97f15d6288b7e3bb38b47b6" }); //PUT YOUR OWN KEY HERE

// get form submissions from JotForm Format: (formID, callback)
JF.getFormSubmissions("223124187496056", function (response) {
  ...
  const map = new mapboxgl.Map({
    ...
    style: "mapbox://styles/mapbox/dark-v10", // Your style URL
  ...
  map.on("load", () => {
    ...
    map.addLayer(
      new MapboxLayer({
        ...
        onClick: (info) => {
          getImageGallery(info.object.fileUpload, info.object.description);
